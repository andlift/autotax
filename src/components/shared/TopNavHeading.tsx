...
const TopNavHeading = () => {
  const { showTopNavDescription, setShowTopNavDescription, isLoaded } = useAppContext();

  // Aguarda o estado ser carregado do localStorage para evitar hydration mismatch
  if (!isLoaded || !showTopNavDescription) {
    return null;
  }
