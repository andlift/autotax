    ...
    <RevealAnimation delay={0.1}>
      <section className="pt-[50px] sm:pb-8 md:pt-[100px] md:pb-14 lg:pb-24 xl:pb-0">
        <div className="main-container">
          <div className="bg-background-2 dark:bg-background-8 mx-auto flex flex-col rounded-[20px] bg-[url('/images/ns-img-170.png')] bg-cover bg-top-right bg-no-repeat max-sm:max-w-[420px] lg:mx-0 lg:max-w-full lg:flex-row">
            ...
            <div className="lg:flex-1/2 lg:pe-5">
              <RevealAnimation delay={0.3} direction="left">
                <div className="relative h-full">
                  <figure className="mx-auto max-w-[300px] max-lg:flex max-lg:items-center max-lg:justify-center sm:max-w-[500px] lg:absolute lg:right-0 lg:bottom-0 lg:max-w-[525px]">
                    <Image
                      src="/images/ns-img-284.png"
