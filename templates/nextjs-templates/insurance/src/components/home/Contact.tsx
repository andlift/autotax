...
const Contact = () => {
  return (
    <section className="xl:py-[200px] lg:-py-[100px] md:py-20 py-16">
      <div className="main-container">
        <div className="flex lg:gap-10 flex-col space-y-18 lg:space-y-0 lg:flex-row lg:justify-between items-center sm:items-start md:items-center">
          <div className="space-y-9 flex-1 flex lg:flex-col md:flex-row flex-col justify-between md:gap-10 lg:gap-0">
            <div className="space-y-7 flex-1">
              <div className="space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="max-w-[517px]">Need more help?</h2>
                </RevealAnimation>
              ...
              <RevealAnimation delay={0.3}>
                <div>
                  <LinkButton
                    href="/support"
                    className="btn btn-white btn-lg dark:btn-transparent hover:btn-primary w-[85%] md:w-auto mx-auto md:mx-0">
                    Contact support
                  </LinkButton>
                </div>
              </RevealAnimation>
            </div>
            <ul className="space-y-3 md:space-y-6 flex-1" aria-label="Contact Information">
              ...
              <RevealAnimation delay={0.6}>
                <li className="flex items-center gap-2">
                  ...
                  <p>4140 Parker Rd, Allentown, NM 31134</p>
                </li>
              </RevealAnimation>
            </ul>
          </div>
          <RevealAnimation delay={0.7} offset={100}>
            <div className="md:p-[42px] p-7 bg-white dark:bg-background-6 rounded-[20px] lg:max-w-[605px] w-full flex-1">
              <form method="post">
                {/* name field  */}
                ...
                <button
                  type="submit"
                  className="btn btn-secondary dark:btn-accent btn-md w-full hover:btn-primary before:content-none first-letter:uppercase"
