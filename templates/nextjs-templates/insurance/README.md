# Insurance SaaS - Next.js Template

A modern, production-ready Next.js 16 SaaS template built for Insurance businesses and SaaS applications. Features a complete set of pages, components, and functionality with React 19, TypeScript, Tailwind CSS 4, and cutting-edge web technologies. Perfect for building smart, fast, and reliable insurance solutions.
...
- ✅ **48 Pages** - Comprehensive page collection for Insurance and SaaS businesses
- ✅ **223+ Components** - Reusable React components with TypeScript
...
│   ├── images/                 # Images (304 files: 137 PNG, 133 SVG, 34 JPG)
│   │   ├── badge/              # Badge images
│   │   ├── icons/              # Icon images
...
export const metadata: Metadata = {
  ...defaultMetadata,
  title: 'New Page - NextSaaS Insurance',
