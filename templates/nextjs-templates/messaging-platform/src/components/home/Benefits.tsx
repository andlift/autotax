...
const Benefits = () => {
  return (
    <section className="py-16 md:py-[100px] lg:pt-[90px] lg:pb-[100px] xl:pt-[100px] xl:pb-[200px]">
      <div className="main-container">
        {/* Benefits Section */}
        <div className="flex flex-col items-center justify-between gap-y-10 md:flex-row-reverse md:gap-x-[70px]">
            ...
            <ul className="list-none">
              <RevealAnimation delay={0.5}>
                <li className="flex items-center gap-3 py-2">
                  <span className="ns-shape-3 text-secondary dark:text-accent text-[36px]"> </span>
                  <div>
                    <p className="text-secondary dark:text-accent font-medium">Loyalty</p>
              ...
              <RevealAnimation delay={0.6}>
                <li className="flex items-center gap-3 py-2">
                  <span className="ns-shape-47 text-secondary dark:text-accent text-[36px]"> </span>
                  <div>
              ...
              <RevealAnimation delay={0.7}>
                <li className="flex items-center gap-3 py-2">
                  <span className="ns-shape-23 text-secondary dark:text-accent text-[36px]"> </span>
                  <div>
          ...
          <div className="relative w-full md:w-1/2">
            ...
            <div className="absolute top-[55%] left-[2%] z-20 flex flex-col items-center 2xl:-left-[8.5%]">
              ...
              <RevealAnimation delay={1.1}>
                <figure className="relative z-40 hidden max-h-[72px] max-w-[300px] overflow-hidden rounded-2xl md:block">
                  <Image
                    src={subFeatures6}
                    alt="Sub features"
              ...
              <RevealAnimation delay={1.2} start="top 96%">
                <figure className="z-30 -mt-[37px] hidden max-h-[72px] max-w-[280px] overflow-hidden rounded-2xl md:block">
                  <Image
                    src={subFeatures7}
                    alt="Sub features"
                    className="shadow-2 block h-auto w-full object-cover object-center dark:hidden"
              ...
              <RevealAnimation delay={1.3} start="top 96%">
                <figure className="z-20 -mt-[37px] hidden max-h-[72px] max-w-[260px] overflow-hidden rounded-2xl lg:block">
                  <Image
                    src={subFeatures8}
                    alt="Sub features"
                    className="shadow-2 block h-auto w-full object-cover object-center dark:hidden"
              ...
              <RevealAnimation delay={1.4} start="top 96%">
                <figure className="-mt-[37px] hidden max-h-[72px] max-w-[240px] overflow-hidden rounded-2xl lg:block">
                  <Image
                    src={subFeatures9}
                    alt="Sub features"
                    className="shadow-2 block h-auto w-full object-cover object-center dark:hidden"
