...
import gradient16Image from '@public/images/ns-img-508.png';
import gradient46Image from '@public/images/ns-img-534.png';
import heroReportBarImage from '@public/images/ns-img-63.png';
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
              <RevealAnimation delay={0.6} instant={true}>
                <div className="bg-background-2 dark:bg-background-6 relative z-0 overflow-hidden rounded-[20px] p-[26px] opacity-0 backdrop-blur-[60px]">
                  <div className="absolute -top-[122px] -left-[180px] -z-10 h-full w-full bg-[url('/images/ns-img-496.png')] bg-cover bg-no-repeat" />
              ...
              <RevealAnimation delay={0.7} instant={true}>
                <div className="bg-background-2 dark:bg-background-6 relative z-0 flex items-center justify-center overflow-hidden rounded-[20px] p-[26px] opacity-0 backdrop-blur-[20px] max-md:min-h-[320px]">
                  <div className="absolute -right-[140px] -bottom-[175px] -z-10 h-full w-full -rotate-180 bg-[url('/images/ns-img-496.png')] bg-[length:117%_106%] bg-no-repeat" />
