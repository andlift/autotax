...
const Reviews = () => {
  return (
    <section className="bg-background-3 dark:bg-background-7 pt-14 pb-14 md:pt-16 md:pb-16 lg:pt-[88px] lg:pb-[88px] xl:pt-[100px] xl:pb-[100px]">
      <div className="main-container">
              ...
              <article className="bg-background-1 dark:bg-background-6 rounded-[20px] p-8">
                <div className="flex items-center justify-between pb-6">
                  <figure className="flex items-center gap-3">
                    ...
                    />
                    <figcaption>
                      <h3 className="text-lg leading-[1.5] font-medium">{testimonial.name}</h3>
                  ...
                  <Link
                    ...
                    className="bg-background-4 dark:bg-background-7 hover:bg-secondary/10 dark:hover:bg-accent/10 flex size-9 cursor-pointer items-center justify-center rounded-full transition-colors duration-400">
                    <svg
                ...
                <p className="border-stroke-4 dark:border-stroke-8 border-t pt-6">{testimonial.quote}</p>
              </article>
            </RevealAnimation>
          ))}
        </div>
        <RevealAnimation delay={0.3}>
          <div className="mt-10 flex justify-center md:mt-14">
            <LinkButton
              href="/testimonial"
              className="btn btn-secondary btn-md hover:btn-primary dark:btn-accent mx-auto w-[90%] md:mx-0 md:w-auto">
              Review us
            </LinkButton>
          </div>
        </RevealAnimation>
