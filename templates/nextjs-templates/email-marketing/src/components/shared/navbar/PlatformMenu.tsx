          ...
          <div className="col-span-12 grid grid-cols-12 gap-x-6 lg:col-span-6">
            <div className="col-span-12 xl:col-span-6">
              <article className="border-stroke-1 dark:border-background-7 group space-y-3 rounded-2xl border p-3">
                <Link onClick={handleClose} href="/blog/an-electronic-prescription-finance" className="block">
                ...
                <div className="space-y-14">
                  <Link href="/blog/an-electronic-prescription-finance" className="block">
                    <div>
                  ...
                  <div>
                    <Link
                      href="/blog/an-electronic-prescription-finance"
            ...
            <div className="col-span-12 xl:col-span-6">
              <article className="border-stroke-1 dark:border-background-7 group space-y-3 rounded-2xl border p-3">
                <Link onClick={handleClose} href="/blog/ai-trends-to-watch-in-2025" className="block">
                  <figure className="overflow-hidden rounded-lg">
                    <Image
                      src={nsImg425}
                      alt="Featured"
