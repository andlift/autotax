...
const SpotlightStories = ({
  customerPageLink,
  shareYourStoryPageLink,
  caseStudyDetailsPageLink,
}: {
  customerPageLink: string;
  shareYourStoryPageLink: string;
  caseStudyDetailsPageLink: string;
}) => {
  return (
