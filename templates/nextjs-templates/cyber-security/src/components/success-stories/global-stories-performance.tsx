...
const GlobalStoriesPerformance = () => {
  return (
    <section className="lg:py-[140px] py-[70px] bg-background-2 dark:bg-background-7">
      <div className="main-container">
        <div className="text-left space-y-3 mb-11 lg:mb-[70px]">
          <h2 data-ns-animate="" data-delay="0.1" className="lg:max-w-[608px] max-w-[450px]">
            Empowering global teams to achieve more
          </h2>
          <p data-ns-animate="" data-delay="0.2" className="lg:max-w-[658px] max-w-[470px]">
        ...
        <RevealAnimation delay={0.3}>
          <div className="flex py-6 md:px-0 px-6 flex-col md:flex-row bg-secondary dark:bg-background-6 rounded-[20px]">
            <div className="py-6 space-y-6 flex-1">
              <div className="xl:w-20 xl:h-[52px] w-16 h-10 bg-ns-green rounded-[30px] mx-auto flex items-center justify-center">
