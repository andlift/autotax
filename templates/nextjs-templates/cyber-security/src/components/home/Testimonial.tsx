...
const Testimonial = () => {
  return (
    <section className="pt-20 pb-14 md:pt-24 md:pb-16 lg:pt-[150px] lg:pb-[88px] xl:pt-[200px] xl:pb-[100px]">
      <div className="mx-auto max-w-[1440px] px-4 md:px-[67px]">
        <div className="mb-14 text-center lg:mb-[70px]">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-green-v2 mb-5"> Reviews </span>
          </RevealAnimation>
      ...
      <RevealAnimation delay={0.3}>
        <div className="relative">
          <div className="from-background-3 dark:from-background-7 absolute top-0 left-0 z-40 h-full w-[15%] bg-gradient-to-r to-transparent " />
          <div className="from-background-3 dark:from-background-7 absolute top-0 right-0 z-40 h-full w-[15%] bg-gradient-to-l to-transparent " />

          <Marquee autoFill pauseOnHover speed={30} className="w-full overflow-hidden">
              ...
              {testimonials.map((testimonial, index) => (
                <div
                  ...
                  <div className="flipper h-full w-full">
                    {/* Front of Card */}
                    <div className="front dark:bg-background-6 border border-stroke-1 dark:border-stroke-5 absolute top-0 left-0 h-fit w-full space-y-8 rounded-[20px] bg-background-2 p-8">
