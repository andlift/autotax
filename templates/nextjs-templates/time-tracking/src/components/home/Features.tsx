...
import feature1 from '@public/images/ns-img-275.png';
import feature2 from '@public/images/ns-img-276.png';
import feature3 from '@public/images/ns-img-277.png';
import feature4 from '@public/images/ns-img-278.png';
import feature5 from '@public/images/ns-img-279.png';
import feature1Dark from '@public/images/ns-img-dark-185.png';
import feature2Dark from '@public/images/ns-img-dark-186.png';
import feature3Dark from '@public/images/ns-img-dark-187.png';
import feature4Dark from '@public/images/ns-img-dark-188.png';
import feature5Dark from '@public/images/ns-img-dark-189.png';
...
const Features = () => {
  return (
    <section className="bg-background-3 dark:bg-background-6 py-20 lg:py-[100px] xl:py-[200px]">
      <div className="main-container">
        <div className="mb-10 space-y-5 text-center md:mb-[72px] lg:mx-auto lg:max-w-[570px]">
        ...
        <div className="grid grid-cols-12 gap-y-14 md:gap-x-8">
          {features.map((feature, index) => (
            <RevealAnimation key={feature.id} delay={0.3 + index * 0.1}>
              <article
                className={cn(
                  'col-span-12 space-y-3 md:col-span-6 lg:col-span-4',
