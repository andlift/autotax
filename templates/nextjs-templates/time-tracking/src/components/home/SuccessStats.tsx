...
const SuccessStats = () => {
  return (
    <section
      className="pb-20 pt-16 md:pb-24 md:pt-20 lg:pb-[125px] lg:pt-[110px] xl:pb-[150px] xl:pt-[140px] bg-background-2 dark:bg-background-5"
      aria-label="Success Metrics">
      <div className="main-container">
        <div className="max-w-[514px] max-lg:mx-auto mb-10 md:mb-[70px] space-y-3">
          <RevealAnimation delay={0.1}>
            <h2>Powering productivity for global teams</h2>
          </RevealAnimation>
        ...
        <RevealAnimation delay={0.3}>
          <div className="bg-secondary dark:bg-background-6 py-6 rounded-[12px] flex flex-col md:flex-row gap-y-4 md:gap-y-0 items-center md:items-start justify-center">
            <div className="flex items-center justify-center flex-col gap-6 flex-1/3 py-[22px]">
              <div className="px-7 py-3.5 bg-ns-green rounded-full w-fit">
              ...
              <h6 className="text-white flex items-center justify-center gap-0.5 text-center">
            ...
            <div className="flex items-center justify-center flex-col gap-6 flex-1/3 py-[22px]">
              ...
              <h6 className="text-white flex items-center justify-center gap-0.5 text-center">
                <NumberAnimation number={50} speed={1000} interval={180} rooms={2} heightSpaceRatio={2.5}>
                  50
                </NumberAnimation>
