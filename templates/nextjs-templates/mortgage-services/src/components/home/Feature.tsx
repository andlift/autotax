import featureImg01 from '@public/images/ns-img-129.png';
import featureImg02 from '@public/images/ns-img-130.png';
import featureImg03 from '@public/images/ns-img-131.png';
import featureImg01Dark from '@public/images/ns-img-dark-98.png';
import featureImg02Dark from '@public/images/ns-img-dark-99.png';
    ...
    <section className="py-16 md:py-[90px] lg:py-[100px]" aria-label="Mortgage Features">
      <div className="main-container">
        <div className="space-y-10 md:space-y-[70px]">
          {/* heading  */}
          <div className="mx-auto max-w-[774px] space-y-3 text-center">
          ...
          <div className="grid grid-cols-12 items-center justify-center gap-y-8 md:gap-x-8">
            {features.map((feature, idx) => (
              <RevealAnimation key={feature.id} delay={0.4 + idx * 0.1}>
                <div
                  className={`dark:bg-background-6 col-span-12 h-full space-y-6 rounded-[20px] bg-white p-6 sm:p-8 md:col-span-6 lg:col-span-4 ${
                    feature.extraClass || ''
                  }`}>
                  ...
                  <figure className="w-full max-w-[344px] overflow-hidden rounded-2xl">
                    <Image
                      src={feature.img}
