# Mortgage Services - Next.js SaaS Template

A comprehensive, modern Next.js SaaS template for mortgage services with complete inner pages. Built with React 19, TypeScript, Tailwind CSS 4, and cutting-edge web technologies for mortgage businesses, financial services, and web applications.
...
- Feature showcase and solutions
...
- **Team**: Team member listings and individual profiles
- **Case Studies**: Case study listings and detailed case studies
- **Career**: Job listings and career detail pages
...
- **Whitepaper**: Whitepaper listings and detailed whitepapers
- **Glossary**: Glossary terms with alphabetical filtering
- **Tutorial**: Tutorial and learning resources
- **Use Case**: Use case examples and scenarios
...
- **Custom Hooks**: 12+ custom React hooks for animations and interactions
...
│   │   ├── career/                 # Markdown career posts (6 files)
│   │   ├── case-study/             # Markdown case studies (16 files)
│   │   ├── customer/               # Markdown customer stories (11 files)
│   │   ├── services/               # Markdown service descriptions (8 files)
│   │   ├── team/                   # Markdown team member profiles (16 files)
...
- **Pricing**: `/pricing`
- **About**: `/about`
- **Blog**: `/blog`, `/blog/[slug]` - Blog listing and individual posts
- **Services**: `/services`, `/services/[slug]` - Service listing and details
- **Team**: `/team`, `/team/[slug]` - Team listing and member profiles
- **Case Studies**: `/case-study`, `/case-study/[slug]` - Case study listing and details
- **Career**: `/career`, `/career/[slug]` - Job listings and career details
- **Customer**: `/customer`, `/customer/[slug]` - Customer success stories
- **Features**: `/features`
- **Contact**: `/contact-us`
...
- **Whitepaper**: `/whitepaper`, `/whitepaper/[slug]` - Whitepaper listing and details
- **Glossary**: `/glossary`, `/glossary/[slug]` - Glossary terms with filtering
- **Tutorial**: `/tutorial`
- **Use Case**: `/use-case`
...
- **Services**: Update service data in `src/data/services/` (8 existing services)
- **Team Members**: Modify team data in `src/data/team/` (16 existing members)
- **Case Studies**: Add case studies in `src/data/case-study/` (16 existing studies)
- **Career**: Add job postings in `src/data/career/` (6 existing positions)
- **Customer Stories**: Add customer stories in `src/data/customer/` (11 existing stories)
- **Whitepapers**: Add whitepapers in `src/data/whitepaper/` (13 existing whitepapers)
