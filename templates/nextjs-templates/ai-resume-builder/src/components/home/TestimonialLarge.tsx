import avatar1 from '@public/images-v2/ns-avatar-15.png';
import avatar6 from '@public/images-v2/ns-avatar-16.png';
import avatar2 from '@public/images-v2/ns-avatar-17.png';
import avatar3 from '@public/images-v2/ns-avatar-21.png';
import avatar4 from '@public/images-v2/ns-avatar-22.png';
import avatar5 from '@public/images-v2/ns-avatar-23.png';
...
const TestimonialLarge = () => {
  return (
    <RevealAnimation delay={0.2}>
      <div className="relative hidden h-[462px] lg:block" role="region" aria-label="Customer testimonials">
