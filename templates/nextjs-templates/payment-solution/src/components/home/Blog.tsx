...
const blogs: IBlogPost[] = getMarkDownData<IBlogPost & { [key: string]: unknown }>('src/data/blogs').slice(0, 3);
      ...
      <div className="main-container">
        ...
        <RevealAnimation delay={0.7}>
          <div className="mt-7 flex justify-center md:mt-14">
            <LinkButton
              href="/blog"
              className="btn hover:btn-primary dark:btn-accent btn-secondary btn-md md:btn-xl mx-auto w-[90%] md:mx-0 md:w-auto"
