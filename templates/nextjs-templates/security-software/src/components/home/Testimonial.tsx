...
import avatar13 from '@public/images/ns-avatar-13.png';
import avatar14 from '@public/images/ns-avatar-14.png';
import avatar9 from '@public/images/ns-avatar-9.png';
import gradient38 from '@public/images/ns-img-526.png';
  ...
  return (
    <section className="py-[75px] md:py-[100px] lg:py-[150px]">
      <div className="main-container">
        <div className="bg-secondary relative overflow-hidden rounded-[20px] px-5 py-10 sm:px-10 sm:py-14 md:px-0 md:py-20">
          <RevealAnimation delay={0.3} offset={100} direction="up">
            <figure className="pointer-events-none absolute top-[-300px] right-[-486px] size-[850px] rotate-[-58deg] overflow-hidden select-none">
              <Image src={gradient38} alt="how-to-work" className="size-full object-cover" width={850} height={850} />
            </figure>
          </RevealAnimation>
          <div className="relative z-10 mb-14 space-y-2 text-center">
            ...
            <RevealAnimation delay={0.3}>
              <p className="text-accent/60 mx-auto max-w-[500px] md:max-w-[648px]">
          ...
          <div className="mx-auto max-w-[740px] space-y-8" aria-label="Customer testimonial">
            {/* avatar + info */}
            <div className="space-y-2 text-center">
              {/* avatar group */}
              <div className="flex items-center justify-center" aria-hidden="true">
                <figure className="ring-stroke-1 z-0 -mr-2 size-7 cursor-pointer overflow-hidden rounded-full bg-white ring-2 sm:size-8 md:size-9">
                  <Image
                    ref={avatar1Ref}
                ...
                <figure className="ring-stroke-1 z-10 -mr-2 size-8 cursor-pointer overflow-hidden rounded-full bg-white ring-2 sm:size-10 md:size-11">
                  <Image
                    ref={avatar2Ref}
                ...
                <figure className="bg-primary-500 relative z-10 size-12 cursor-pointer overflow-hidden rounded-full ring-2 ring-white sm:size-16 md:size-[72px]">
                  <Image
                    ref={avatar3Ref}
                ...
                <figure className="ring-stroke-1 z-[2] -ml-2 size-8 cursor-pointer overflow-hidden rounded-full bg-white ring-2 transition-all sm:size-10 md:size-11">
                  <Image
                    ref={avatar4Ref}
                ...
                <figure className="ring-stroke-1 z-0 -ml-2 size-7 cursor-pointer overflow-hidden rounded-full bg-white ring-2 sm:size-8 md:size-9">
                  <Image
                    ref={avatar5Ref}
              ...
              {/* name & role */}
              <div>
                <h4 ref={nameRef} className="text-tagline-1 text-accent font-medium">
            ...
            {/* testimonial quote */}
            <blockquote className="mx-auto max-w-[500px] text-center md:max-w-[652px]">
