  ...
  return (
    <section className="pt-16 pb-16 md:pt-20 md:pb-20 lg:pt-[90px] lg:pb-[90px] xl:pt-[100px] xl:pb-[100px]">
      <div className="main-container">
        <div className="flex flex-col items-center justify-center gap-y-10 sm:gap-y-16 md:flex-row md:items-start md:justify-between md:gap-x-8 lg:gap-x-16 xl:gap-x-[140px]">
          {/* Left: Intro */}
          <div className="text-center md:text-left lg:sticky lg:top-28">
            ...
            <RevealAnimation delay={0.4}>
              <div className="mt-10 md:mt-14">
                <LinkButton
                  href="/integration"
                  className="btn btn-md btn-secondary hover:btn-primary dark:btn-transparent mx-auto w-[85%] md:mx-0 md:w-auto">
                  Learn more
                </LinkButton>
              </div>
            </RevealAnimation>
          ...
          <StackCardWrapper topOffset="10vh" gap="24px" initDelay={100} className="w-full max-w-xl">
            {whyChooseFeatures.map((feature) => (
              <StackCardItem key={feature.id}>
                <div className="bg-background-2 dark:bg-background-6 border-stroke-4 dark:border-stroke-5 min-h-[170px] space-y-4 rounded-[20px] border p-8 max-sm:min-h-[245px]">
                  <div className="mx-auto inline-block">
                    <span className={`${feature.icon} text-secondary dark:text-accent text-[48px]`} />
                  </div>
                  <div>
