...
import companyImage from '@public/images/ns-img-50.png';
import companyDarkImage from '@public/images/ns-img-dark-29.png';
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="mx-auto max-w-[600px] text-center xl:mx-0 xl:max-w-full xl:text-left">
              ...
              <RevealAnimation delay={0.6}>
                <div>
                  <LinkButton href="/features" className="btn btn-secondary btn-md dark:btn-accent hover:btn-primary">
                    <span>Read More</span>
                  </LinkButton>
                </div>
              </RevealAnimation>
          ...
          <div className="col-span-12 xl:col-span-6">
            <RevealAnimation delay={0.7}>
              <figure className="mx-auto w-full max-w-[592px]">
                <Image src={companyImage} alt="solutions" className="w-full dark:hidden" priority />
                <Image src={companyDarkImage} alt="solutions" className="hidden w-full dark:block" priority />
              </figure>
            </RevealAnimation>
          </div>
        </div>
