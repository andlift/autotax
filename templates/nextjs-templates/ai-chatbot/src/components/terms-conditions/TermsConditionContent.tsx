    ...
    <section className="pt-32 pb-14 sm:pt-36 md:pt-42 md:pb-16 lg:pb-[88px] xl:pt-[180px] xl:pb-[200px]">
      <div className="main-container">
        ...
        <article className="terms-conditions-body">
          ...
          <RevealAnimation delay={0.4}>
            <Link href="/refund-policy" className="btn btn-xl btn-secondary dark:btn-accent hover:btn-primary">
          ...
          <RevealAnimation delay={0.4}>
            <Link href="/privacy-policy" className="btn btn-xl btn-secondary dark:btn-accent hover:btn-primary">
...
TermsConditionContent.displayName = 'TermsConditionContent';
