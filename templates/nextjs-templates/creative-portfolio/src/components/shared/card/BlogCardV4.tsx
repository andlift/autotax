...
const BlogCardV4 = ({ blog, className }: BlogCardV4Props) => {
  return (
    <div>
      <article
        className={cn(
          'rounded-[20px] overflow-hidden bg-background-2 dark:bg-background-7 max-w-[627px] lg:max-w-full lg:mx-0 mx-auto scale-100 hover:scale-[102%] transition-transform duration-500 hover:transition-transform hover:duration-500',
          className,
        )}>
        <figure className="lg:max-w-[629px] max-w-full w-full h-[260px] overflow-hidden rounded-[20px]">
          <Image src={blog.thumbnail} alt="blog" className="w-full h-full object-cover" width={629} height={260} />
        </figure>
        <div className="p-8">
