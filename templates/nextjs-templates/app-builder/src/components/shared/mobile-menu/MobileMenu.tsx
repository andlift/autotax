...
const MobileMenu = ({ menuData }: { menuData: MobileMenuGroup[] }) => {
  ...
  return (
    <aside
      className={cn(
        'dark:bg-background-8 scroll-bar fixed top-0 right-0 z-[9999] h-screen w-full translate-x-full rounded-t-2xl rounded-l-3xl bg-white transition-all duration-300 sm:w-1/2 xl:hidden',
