            ...
            <div className="grid grid-cols-12 items-start gap-y-8 lg:gap-x-8 xl:items-center">
              <div className="col-span-12 lg:col-span-5 xl:col-span-6">
                <RevealAnimation delay={0.3}>
                  <BlogCardV4 blog={blogsData[0]} className="dark:bg-background-8 bg-white" />
                </RevealAnimation>
              </div>
              <div className="col-span-12 lg:col-span-7 xl:col-span-6">
                <div className="space-y-8 lg:space-y-[38px] xl:space-y-8">
                  <RevealAnimation delay={0.4}>
                    <BlogCardV5 blog={blogsData[1]} className="dark:bg-background-8 bg-white" />
                  </RevealAnimation>
                  <RevealAnimation delay={0.5}>
                    <BlogCardV5 blog={blogsData[2]} className="dark:bg-background-8 bg-white" />
                  </RevealAnimation>
                </div>
              </div>
            </div>
